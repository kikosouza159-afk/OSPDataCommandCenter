Projeto gerado a partir do cockpit_v1_5_corrige_percentual_abandono_v2 com integração do cliente Sky | Assistpay.

O que foi incluído:
- Cliente Sky | Assistpay no cockpit.
...
- Incluída nova aba "Funil Comparativo" dentro do painel Sky Assistpay.
